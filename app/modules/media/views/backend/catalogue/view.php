					...
					<div class="ibox-content" style="position:relative;">
						<div class="table-responsive">
                            ...
                            $listIS = $this->Autoload_Model->_get_where(array(
                                'select' => '*',
                                'table' => 'general_is',
                                'where' => array('module' => 'media_catalogue', 'publish' => 1),
                            ), TRUE);
                            ?>
									...
									<?php if(isset($listCatalogue) && is_array($listCatalogue) && count($listCatalogue)){ ?>
										...
										?>
											<tr class="gradeX" id="cat-<?php echo $val['id']; ?>">
												...
												<td><a class="maintitle" style="<?php echo ($val['level'] == 1) ? 'font-weight:600;' : ''; ?>" href="<?php echo site_url('media/backend/media/view?catalogueid='.$val['id'].''); ?>" title=""><?php echo str_repeat('|----', (($val['level'] > 0)?($val['level'] - 1):0)).$val['title']; ?> (<?php echo $count; ?>)</a>
												...
												<td class="text-center">
													...
													<a <?php echo ($val['rgt'] - $val['lft'] > 1) ? 'disabled="disabled" ': ''; ?> type="button" class="btn btn-danger hidden <?php echo ($val['rgt'] - $val['lft'] > 1) ? '" ': 'ajax-delete'; ?>" data-title="Lưu ý: Khi bạn xóa danh mục, toàn bộ media trong nhóm này sẽ bị xóa. Hãy chắc chắn rằng bạn muốn thực hiện hành động này!" data-router="<?php echo $val['canonical']; ?>" data-id="<?php echo $val['id'] ?>" data-module="media_catalogue" data-child="1"><i class="fa fa-trash"></i></a>
												</td>
											</tr>
										<?php }}else{ ?>
											<tr>
