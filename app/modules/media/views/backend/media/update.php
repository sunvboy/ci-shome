									...
									<div class="form-row">
										...
										<div class="outer">
											<div class="uk-flex uk-flex-middle">
												...
												<?php echo form_input('canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', $detailMedia['canonical']))), 'class="form-control canonical" placeholder="" autocomplete="off" data-flag="0" ');?>
