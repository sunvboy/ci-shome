				...
				<div class="ibox float-e-margins">
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-article">
								<li><a type="button" class="ajax-delete-all" data-title="Lưu ý: Khi bạn thực hiện thao tác này, toàn bộ dữ liệu sẽ không thể khôi phục được. Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="media">Xóa tất cả</a>
								</li>
							</ul>
							<a class="close-link">
					...
					<div class="ibox-content" style="position:relative;">
						<div class="table-responsive">
							<div class="uk-flex uk-flex-middle uk-flex-space-between hidden">
								<div class="perpage">
                            ...
                            $listIS = $this->Autoload_Model->_get_where(array(
                                'select' => '*',
                                'table' => 'general_is',
                                'where' => array('module' => 'media', 'publish' => 1),
                            ), TRUE);
                            ?>
											...
											<tr class="gradeX" id="post-<?php echo $val['id']; ?>">
												...
												<td>
													<div class="uk-flex uk-flex-middle">
														...
														<div class="main-info">
															<div class="title"><a class="maintitle" href="<?php echo site_url('media/backend/media/update/'.$val['id']); ?>" title=""><?php echo $val['title']; ?> (<?php echo $val['viewed']; ?>)</a>                                                            <a href="<?php echo $href ?>" title="Lấy địa chỉ liên kết" onclick="prompt('Lấy địa chỉ liên kết','<?php echo $href ?>'); return false;"><img border="0" src="template/backend/img/link.png"></a>
                                                            </div>
												...
												<td class="text-center">
													...
													<a type="button" class="btn btn-danger ajax-delete hidden" data-title="Lưu ý: Dữ liệu sẽ không thể khôi phục. Hãy chắc chắn rằng bạn muốn thực hiện hành động này!" data-router="<?php echo $val['canonical']; ?>" data-id="<?php echo $val['id'] ?>" data-module="media"><i class="fa fa-trash"></i></a>
												</td>
											</tr>
										<?php }}else{ ?>
											<tr>
