	...
	public function view($page = 1){
		...
		if($config['total_rows'] > 0){
			...
			$data['listCatalogue'] = $this->Autoload_Model->_get_where(array(
				'select' => 'id, title, canonical, publish, created, order, level, lft, rgt,ishome,highlight,isaside,isfooter, (SELECT fullname FROM user WHERE user.id = media_catalogue.userid_created) as user_created',
				'table' => 'media_catalogue',
                'where' => array('alanguage' => $this->fclang),
