        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <ul class="nav nav-pills mb20">
                ...
                <?php if (isset($tab) && is_array($tab) && count($tab)) { ?>
                    ...
                    <?php $i=0; foreach ($tab as $key => $val) { $i++;?>
                                                                ...
                                                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                                    ...
                                                                    <?php if (isset($valItem['id'])) { ?>
                                                                        ...
                                                                        <span style="color:#9fafba;"><span
                                                                                    ...
                                                                                    id="<?php echo $valItem['id']; ?>"><?php echo strlen(slug($systems[$key . '_' . $keyItem])) ?></span> <?php echo (isset($valItem['extend'])) ? $valItem['extend'] : ''; ?></span>
