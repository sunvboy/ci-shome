					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-page">
								<li><a type="button" class="ajax-delete-all" data-title="Lưu ý: Khi bạn xóa danh mục nội dung tĩnh, toàn bộ nội dung tĩnh trong nhóm này sẽ bị xóa. Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="page_catalogue">Xóa tất cả</a>
								</li>
							</ul>
							<a class="close-link">
					...
					<div class="ibox-content" style="position:relative;">
						<div class="table-responsive">
                            ...
                            $listIS = $this->Autoload_Model->_get_where(array(
                                'select' => '*',
                                'table' => 'general_is',
                                'where' => array('module' => 'page_catalogue', 'publish' => 1),
                            ), TRUE);
                            ?>
