						...
						<div class="ibox-content" style="position:relative;">
							<div class="table-responsive">
								<div class=" mb10 uk-flex uk-flex-middle uk-flex-space-between">
									<div class="row-left">
										<?php echo form_dropdown('perpage', $this->configbie->data('perpage'), set_value('perpage') ,'data-module="contact" class="form-control input-sm perpage filter"  data-url="'.site_url('contact/backend/catalogue/view').'"'); ?>
									</div>
									<div class="row-right">
										<div class="uk-flex uk-flex-middle uk-flex-space-between">
											...
											<div class="uk-search uk-flex uk-flex-middle mr10">
												<form class="uk-form" id="search">
													 <input data-module="contact" type="search" name="keyword"  class="keyword form-control input-sm filter" placeholder="Nhập từ khóa tìm kiếm ..." autocomplete="off" value="<?php echo $this->input->get('keyword'); ?>" >
												</form>
											</div>
										</div>
									</div>
									...
									<thead>
										<tr>
											...
											<!-- <th style="width:40px;"></th> -->
											 <th style="width:40px;">Tiêu đề</th>
