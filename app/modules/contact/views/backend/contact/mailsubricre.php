    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><strong>Danh sách đăng ký nhận bản tin khuyến mại</strong></li>
            </ol>
        </div>
    </div>
    <!-- --------------------------- -->
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Danh sách đăng ký nhận bản tin khuyến mại</h5>
                            <div class="ibox-tools">
                                <a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-wrench"></i></a>
                                <ul class="dropdown-menu dropdown-contact">
                                    <li><a  type="button" class="ajax-delete-all" data-title="Lưu ý: Khi bạn thực hiện thao tác này, toàn bộ dữ liệu sẽ không thể khôi phục được. Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="contact">Xóa tất cả</a></li>
                                </ul>
                        ...
                        <div class="ibox-content" style="position:relative;">
                            <div class="table-responsive">
                                <div class=" mb10 uk-flex uk-flex-middle uk-flex-space-between">
                                    <div class="row-left">
                                        <?php echo form_dropdown('perpage', $this->configbie->data('perpage'), set_value('perpage') ,'data-module="mailsubricre" class="form-control input-sm perpage filter"  data-url="'.site_url('contact/backend/catalogue/view').'"'); ?>
                                    </div>
                                    <div class="row-right">
                                        <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                            ...
                                            <div class="uk-search uk-flex uk-flex-middle mr10">
                                                <form class="uk-form" id="search">
                                                     <input data-module="mailsubricre" type="search" name="keyword"  class="keyword form-control input-sm filter" placeholder="Nhập từ khóa tìm kiếm ..." autocomplete="off" value="<?php echo $this->input->get('keyword'); ?>" >
                                                </form>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <?php if(isset($listContact) && is_array($listContact) && count($listContact)){ ?>
                                        <?php foreach($listContact as $key => $val){?>
                                            <tr class="gradeX" id="">
                                                ...
                                                <td class="pd-top"><?php echo $val['title']; ?></td>
                                                ...
                                                <td class="pd-top "><?php echo $val['phone']; ?></td>
                                                <td class="pd-top "><?php echo $val['message']; ?></td>
                                                <td class="pd-top text-center"><?php echo gettime($val['created'],' h:i:s d/m/Y'); ?></td>
