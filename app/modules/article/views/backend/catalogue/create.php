							...
							<div class="row">
								<div class="col-lg-12">
									<div class="google">
										...
										<div class="g-description line-3" id="metaDescription">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <div class="avatar" style="cursor: pointer;"><img src="template/not-found.png" class="img-thumbnail" alt=""></div>
                                        <?php echo form_input('images', htmlspecialchars_decode(html_entity_decode(set_value('images'))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"');?>
                                    </div>
                                </div>
                            </div>
                        </div>
