									...
									<div class="form-row">
										...
										<div class="outer">
											<div class="uk-flex uk-flex-middle">
												...
												<?php echo form_input('canonical', htmlspecialchars_decode(html_entity_decode(set_value('canonical', $detailCatalogue['canonical']))), 'class="form-control canonical" placeholder="" autocomplete="off" data-flag="0" ');?>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image', $detailCatalogue['image']))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"');?>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="ibox mb20">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<div class="avatar" style="cursor: pointer;"><img src="<?php echo ($this->input->post('images')) ? $this->input->post('images') : ((!empty($detailCatalogue['images'])) ? $detailCatalogue['images'] : 'template/not-found.png'); ?>" class="img-thumbnail" alt=""></div>
										<?php echo form_input('images', htmlspecialchars_decode(html_entity_decode(set_value('images', $detailCatalogue['images']))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"');?>
									</div>
								</div>
							</div>
						</div>
