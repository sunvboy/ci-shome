			...
			<div class="row">
				<div class="col-lg-8 clearfix">
                    <ul class="nav nav-pills ">
                        ...
                        <li><a data-toggle="tab" href="#menu1">ALBUM DỰ ÁN</a></li>
                    </ul>
                                    ...
                                    <div class="row mb15 hidden">
                                        <div class="col-lg-12">
                                            <div class="form-row">
                                                ...
                                                <?php echo form_input('amp', htmlspecialchars_decode(html_entity_decode(set_value('amp'))), 'class="form-control " placeholder=""  autocomplete="off"');?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb15">
                                    ...
                                    if (isset($albumC) && is_array($albumC) && count($albumC)) { ?>
                                        <?php foreach ($albumC['images'] as $key => $val) {
                                            ...
                                            <div class="col-sm-4 slideItem" style="height: auto;">
                                                <div class="thumb"><img src="<?php echo $albumC['images'][$key]; ?>" class="img-thumbnail img-responsive"/></div>
                                                <input type="hidden" name="albumC[images][]" value="<?php echo $albumC['images'][$key]; ?>"/>
...
<script>
    ...
    item = item + '<input type="hidden" name="albumC[images][]" value="STT" />';
