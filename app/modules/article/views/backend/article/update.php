                                    ...
                                    <div class="row mb15 hide">
                                        <div class="col-lg-12">
                                            <div class="form-row">
                                                ...
                                                <?php echo form_input('amp', htmlspecialchars_decode(html_entity_decode(set_value('amp', $detailArticle['amp']))), 'class="form-control " placeholder=""  autocomplete="off"');?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row mb15">
                            ...
                            <div class="box-body">
                                <div class="form-group" id="fromSlide">
                                    ...
                                    if (isset($slide) && is_array($slide) && count($slide)) {
                                        ...
                                        $albumC = json_decode($detailArticle['albums'], TRUE);
                                    }
                                    ?>
                                    <?php if (isset($albumC) && is_array($albumC) && count($albumC)) { ?>
                                        <?php foreach ($albumC as $key => $val) {
                                            ...
                                            <div class="col-sm-4 slideItem" style="height: auto;">
                                                <div class="thumb "><img src="<?php echo $albumC[$key]['images']; ?>"class="img-thumbnail img-responsive"/></div>
