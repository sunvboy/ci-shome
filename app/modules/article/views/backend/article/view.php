											...
											<tr class="gradeX" id="post-<?php echo $val['id']; ?>">
												...
												<td>
													<div class="uk-flex uk-flex-middle">
														...
														<div class="main-info">
															<div class="title">
                                                                <a class="maintitle" href="<?php echo site_url('article/backend/article/update/'.$val['id']); ?>" title=""><?php echo $val['title']; ?> (<?php echo $val['viewed']; ?>)</a>
                                                ...
                                                <?php if(is_array($listIS) && count($listIS) && isset($listIS)){?>
                                                    <?php foreach ($listIS as $keyIS=>$valIS){?>
                                                        <td class="">
                                                            <div class="switch">
                                                                <div class="onoffswitch">
                                                                    <input type="checkbox" <?php echo ($val[''.$valIS['is'].''] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="article" data-title="<?php echo $valIS['is']?>" data-id="<?php echo $val['id']; ?>" id="publish_<?php echo $valIS['is']?><?php echo $val['id']; ?>">
                                                                    <label class="onoffswitch-label" for="publish_<?php echo $valIS['is']?><?php echo $val['id']; ?>">
                                                                        <span class="onoffswitch-inner"></span>
                                                                        <span class="onoffswitch-switch"></span>
                                                                    </label>
                                                                </div>
