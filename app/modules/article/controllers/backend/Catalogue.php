	...
	public function view($page = 1){
		...
		if($config['total_rows'] > 0){
			...
			$data['listCatalogue'] = $this->Autoload_Model->_get_where(array(
				'select' => 'id, title, canonical, publish,ishome,highlight,isaside,isfooter, created, order, level, lft, rgt, (SELECT fullname FROM user WHERE user.id = article_catalogue.userid_created) as user_created',
				'table' => 'article_catalogue',
				'where' => array( 'alanguage' => $this->fclang),
