    ...
    public function View()
    {
        ...
        if ($config['total_rows'] > 0) {
            ...
            foreach ($data['listCatalogue'] as $key => $val) {
                ...
                $listCatalogue .= '<a type="button" href="'. site_url('customer/backend/catalogue/update/'.$val['id']).'" class="btn btn-sm btn-edit btn-primary"><i class="fa fa-edit"></i></a>';
                $listCatalogue .= '<a type="button" href="javascript:void(0)" data-title="'.$val['title'].'" data-name="" data-module="customer_catalogue" data-id="'.$val['id'].'" class="btn btn-sm btn-trash btn-danger ajax-delete"><i class="fa fa-trash"></i></a>';
                $listCatalogue .= '</td>';
                $listCatalogue .= '</tr>';
            }
