            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="breadcrumb-wrapper">
                        ...
                        <span class="ttm-textcolor-skincolor">Thanh toán</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="checkout-section clearfix" style="padding-top: 0px">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form name="checkout" method="post" class="checkout row" action="" id="RegForm">
                        <div class="col-lg-6">
                                ...
                                <div class="billing-fields-wrapper pt-10">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-row">
                                                ...
                                                <?php echo form_input('fullname', set_value('fullname'), 'class="input-text" autocomplete="off"'); ?>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-row">
                                                ...
                                                <?php echo form_input('phone', set_value('phone'), 'class="input-text" autocomplete="off"'); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-row">
                                                <label>Địa chỉ</label>
                                                <?php echo form_input('address_detail', set_value('address_detail'), 'class="input-text" placeholder="Nhập địa chỉ đầy đủ: Số nhà, tên đường" autocomplete="off"'); ?>
                                ...
                                <div id="order_review" class="checkout-review-order">
                                    <table class="cart_table checkout-review-order-table">
                                        ...
                                        <tr class="order-total">
                                            <th>Tổng tiền</th>
                                            <td><strong><span class="woocommerce-Price-amount amount"><?php echo $total_cart_coupon ?>đ</span></strong>
                                            </td>
                                        </tr>
                                        </tfoot>
                                    </table>
                        ...
                        <div class="col-lg-3">
                            <div class="text-right place-order mt-30">
                                <button type="submit" class="button" name="create" id="place_order" value="create">Thanh toán</button>
                                <button type="button" class="button" id="loadingDiv">Dữ liệu đang được xử lý....</button>
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                <div class="extend-option">
                                    <div class="option-1">
                                        <div class="uk-flex uk-flex-middle check">
                                            ...
                                            <span class="lb-title">Yêu cầu XPAND xuất hóa đơn VAT cho công ty hoặc tổ chức</span>
                                        </div>
