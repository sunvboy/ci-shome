                            ...
                            <div class="ibox-content">
                                <div class="row m-b">
                                    <table class="table shoping-cart-table">
                                        <tbody>
                                        <?php $giagoc = 0;
                                        if (isset($data_order) && is_array($data_order) && count($data_order)) { ?>
                                            <?php foreach ($data_order as $key => $val) {
                                                $quantity = $val['quantity'];
                                                $price = $val['price'];
                                                $money_row = $price * $quantity;
                                                ?>
                                                <tr>
                                                    <td width="70">
                                                    ...
                                                    <td class="desc">
                                                        <h5><?php echo $val['title'] ?>
                                                        </h5>
                                                        <?php if (!empty($val['options']['mattrai'])) { ?>

                                                            <span class="product-info-name">
                                                                <strong><b>Độ cận:</b> <?php echo $val['options']['mattrai'] ?></strong>
                                                    ...
                                                    <td>
			                                    	<span>
			                                    		<span class="" data-val="<?php echo $quantity ?>">
			                                    		<?php echo $quantity ?>
				                                    	</span>
                                                    ...
                                                    <td>
                                                        <b class="nowrap">
                                                            <?php echo number_format($money_row) . 'đ' ?>
                                ...
                                <div class="row m-b hidden" style="border-top: 1px solid #ebeef0; padding-top: 10px">
                                    <div class="col-sm-12">
                                ...
                                <div class="row m-b" style="border-top: 1px solid #ebeef0; padding-top: 10px">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="row m-b-sm">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="text-right">
                                                    <?php echo number_format($detailorder['total_cart_final']-$detailorder['ship']) . 'đ' ?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row m-b-sm">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="text-right">
                                                    <b><?php echo number_format($detailorder['ship']) . 'đ' ?></b>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row m-b-sm hidden">
                                            <div class="col-sm-9">
                                                <div class="text-right">
                                                    Giảm giá KM:
                                                </div>
                                        ...
                                        <div class="row m-b-sm hidden">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="text-right">
												<span>
		                                    		<span class="js_change_input"
                                                          data-val="<?php echo $discount_other ?>">
                                        ...
                                        <div class="row m-b-sm">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="text-right">
                                                    <b><?php echo number_format($detailorder['total_cart_final']) . 'đ' ?></b>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row m-b-sm hidden">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="text-right">
                                                    <b><?php echo addCommas($giagoc) . 'đ' ?></b>
                                                </div>
                                            </div>
                                        </div>
                                        <?php
                                        $list_promotional_detail = json_decode($detailorder['coupon_json'], true);
                                        if (isset($list_promotional_detail) && is_array($list_promotional_detail) && count($list_promotional_detail)) {
                                            ?>
                                            <div class="row m-b-sm">
                                                <div class="col-sm-9">
                                                    <div class="text-right">
                                                        <b>Mã khuyến mại được áp dụng:</b>
                                                    </div>
                                                </div>
                                                <div class="col-sm-3">
                                                    <div class="text-right">
                                                        <?php foreach ($list_promotional_detail as $key => $promotional_detail) { ?>
                                                            <div class="text-muted small">
                                                                <b><?php echo $key; ?></b><br><?php echo $promotional_detail['promo_detail'] ?>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="row m-b">
                                ...
                                <div class="col-sm-8  js_change_input_1">
                                    <div class="text-right">
                                        ...
                                        <?php echo form_input('phone', set_value('phone', $detailorder['phone']), 'class="form-control input-sm inline-block" style="width:120px; display:none" placeholder="" autocomplete="off"'); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row m-b">
                                ...
                                <div class="col-sm-8  js_change_input_1">
                                    <div class="text-right">
                                        <div class="text-right">
											<span class="js_change_input"
                                                  data-val="<?php echo $detailorder['email'] ?>">
                            ...
                            <div class="row m-b">
                                ...
                                <div class="col-sm-9  js_change_input_1">
                                    <div class="text-right">
										<span class="js_change_input" data-val="">
                                			<?php echo $detailorder['address_detail'] . ' - ' . $detailorder['address_city'] . ' - ' . $detailorder['address_distric'] ?>
                                    	</span>
                                        <span style="display: none">
											...
											<select name="districtid" id="district"
                                                    class="location form_dropdown input-sm  m-b-sm">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <input type="hidden" value="<?php echo $giagoc ?>" name="total_lai">
                                    <button name="close" class="js_close_windown btn btn-danger pull-right">Đóng
                                    </button>
                                    <button type="submit" name="update" value="update"
                                            class="btn btn-success  m-r-sm  pull-right">Lưu
                                    </button>
                                </div>
                            </div>
                        </div>
