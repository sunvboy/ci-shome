...
class Order extends MY_Controller {
	...
	public function Update($id = 0){
		...
		$detailorder = $this->Autoload_Model->_get_where(array(
			'select' => 'id,payment,coupon_json, fullname, created, cart_json, updated, order, total_cart_final, status,quantity, promotional_detail, fullname , phone, email, note, address_detail, cityid, , cart_json, extend_json, districtid, wardid,ship,
		...
		if($this->input->post('update')){
			...
			/*$param['total_lai'] = $this->input->post('total_lai');
