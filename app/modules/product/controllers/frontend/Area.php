...
class Area extends MY_Controller {
	...
	function __construct() {
		...
		$this->load->library('nestedsetbie', array('table' => 'product_area'));
	...
	public function view($catalogueid = 0, $page = 1){
        ...
        $config['total_rows'] = $this->Autoload_Model->_get_where(array(
            ...
            'where' => array('tb1.productAreaID' => $catalogueid,'tb1.publish' => 0,'tb1.alanguage' => $this->fc_lang),
            'distinct' => 'true',
            'count' =>TRUE,
        ));
        ...
        if($config['total_rows'] > 0){
            ...
            $productList = $this->Autoload_Model->_get_where(array(
                'distinct' => 'true',
                'select' => 'tb1.customerid,tb1.id, tb1.id as productid, tb1.title, tb1.canonical, tb1.price, tb1.price_sale, tb1.price_contact, tb1.image, tb1.order,tb1.description,tb1.supportID,tb1.productAreaID,tb1.donvi',
                'table' => 'product as tb1',
                'where' => array('tb1.productAreaID' => $catalogueid,'tb1.publish' => 0,'tb1.image !=' => '','tb1.alanguage' => $this->fc_lang),
		...
		$data['template'] = 'product/frontend/area/view';
