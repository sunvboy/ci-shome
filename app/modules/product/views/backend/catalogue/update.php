					...
					<div class="ibox mb20 hidden">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<select name="article[]" data-json="<?php echo base64_encode($article) ?>" data-condition="" class="form-control selectMultipe filter" multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm theo bài viết.." data-module="article"  style="width:100%"></select>
