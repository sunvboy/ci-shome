					...
					<div class="ibox mb20 hidden">
						...
						<div class="ibox-content">
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										<select name="article[]" data-json="<?php echo base64_encode($article) ?>" data-condition="" class="form-control selectMultipe filter" multiple="multiple" data-title="Nhập 2 kí tự để tìm kiếm theo tên bài viết.." data-module="article"  style="width:100%"></select>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-row">
										...
										<?php echo form_input('image', htmlspecialchars_decode(html_entity_decode(set_value('image'))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"');?>
									</div>
								</div>
							</div>
						</div>
