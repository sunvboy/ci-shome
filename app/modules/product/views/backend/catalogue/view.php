					...
					<div class="ibox-title">
						...
						<div class="ibox-tools">
							...
							<ul class="dropdown-menu dropdown-product">
								<li><a type="button" class="ajax-delete-all" data-title="Lưu ý: Khi bạn xóa danh mục sản phẩm, toàn bộ sản phẩm trong nhóm này sẽ bị xóa. Hãy chắc chắn rằng bạn muốn thực hiện chức năng này!" data-module="product_catalogue">Xóa</a>
								</li>
					...
					<div class="ibox-content" style="position:relative;">
						<div class="table-responsive">
                            ...
                            $listIS = $this->Autoload_Model->_get_where(array(
                                'select' => '*',
                                'table' => 'general_is',
                                'where' => array('module' => 'product_catalogue', 'publish' => 1),
                            ), TRUE);
                            ?>
							<table class="table table-bordered dataTables-example" >
								...
								<tbody id="ajax-content" class='nd_accordion'>
									<?php if(isset($listCatalogue) && is_array($listCatalogue) && count($listCatalogue)){ ?>
										...
										?>
											<tr class="gradeX" data-level ="<?php echo $val['level'] ?>" id="cat-<?php echo $val['id']; ?>">
												<td>
												...
												<td>
													<div class="uk-flex uk-flex-middle uk-flex-space-between">
														<div class="uk-flex uk-flex-middle">
															<div class="m-r hidden" style="width: 42px; height: 42px; background: #7f8c8d">
												...
												<td>
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" <?php echo ($val['publish'] == 0) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="product_catalogue" data-title="publish" data-id="<?php echo $val['id']; ?>" id="publish_frontendpublish-<?php echo $val['id']; ?>">
															<label class="onoffswitch-label" for="publish_frontendpublish-<?php echo $val['id']; ?>">
																<span class="onoffswitch-inner"></span>
																<span class="onoffswitch-switch"></span>
															</label>
														</div>
