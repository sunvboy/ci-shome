                                                ...
                                                <td>
                                                    <div class="switch">
                                                        <div class="onoffswitch">
                                                            <input type="checkbox" <?php echo ($val['ishome'] == 1) ? 'checked=""' : ''; ?> class="onoffswitch-checkbox publish_frontend" data-module="product_brand" data-title="ishome" data-id="<?php echo $val['id']; ?>" id="publishishome-<?php echo $val['id']; ?>">
                                                            <label class="onoffswitch-label" for="publishishome-<?php echo $val['id']; ?>">
