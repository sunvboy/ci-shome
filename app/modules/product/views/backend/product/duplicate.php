...
<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
    ...
    <form method="post" action="" class="form-horizontal box" >
        <div class="ibox-tools" id="create_product">
            <button type="submit" name="create" value="create" class="btn btn-success block full-width m-b">Thêm mới</button>
        </div>
        ...
        <div class="wrapper wrapper-content animated fadeInRight">
            ...
            <div class="row">
                <div class="col-lg-8 clearfix">
                                ...
                                <div class="ibox-title" style="padding: 9px 15px 0px;">
                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                        ...
                                        <div class="ibox-tools">
                                            <button type="submit" name="create" value="create" class="btn btn-success  full-width ">Thêm mới</button>
                                        </div>
                                    ...
                                    <?php if (isset($albumC) && is_array($albumC) && count($albumC)) { ?>
                                        <?php foreach ($albumC as $key => $val) {
                                            ...
                                            <div class="col-sm-4 slideItem" style="height: auto;">
                                                <div class="thumb "><img src="<?php echo !empty($albumC[$key]['images'])?$albumC[$key]['images']:'template/not-found.png'; ?>"  class="img-thumbnail img-responsive"/></div>
                                                <input type="hidden" name="albumC[images][]" value="<?php echo $albumC[$key]['images']; ?>"/>
                                                <input type="text" name="albumC[title][]"  value="<?php echo $albumC[$key]['title']; ?>"  class="form-control  " placeholder="Tên "/>
                                                <textarea name="albumC[description][]" cols="40" rows="10" class="form-control"  placeholder="Giá"><?php echo $albumC[$key]['description']; ?></textarea>
                    ...
                    <button type="submit" name="create" value="create" class="btn btn-success block m-b pull-right">Thêm mới</button>
                    ...
                    <div class="ibox mb20 hidden">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <div class="avatar" style="cursor: pointer;"><img src="<?php echo ($this->input->post('banner')) ? $this->input->post('banner') : ((!empty($product['banner'])) ? $product['banner'] : 'template/not-found.png')?>" class="img-thumbnail" alt=""></div>
...
<script>
    ...
    item = item + '<textarea name="albumC[description][]" cols="40" rows="10" class="form-control hidden" placeholder="Giá"></textarea>';
