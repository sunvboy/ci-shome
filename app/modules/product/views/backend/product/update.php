            ...
            <div class="row">
                <div class="col-lg-8 clearfix">
                    <ul class="nav nav-pills ">
                        ...
                        <li><a data-toggle="tab" href="#menu1">Quà tặng</a></li>
                    ...
                    <div class="tab-content">
                        <div class="ibox mb20">
                            <div class="ibox-title" style="padding: 9px 15px 0px;">
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    <h5>Thông tin cơ bản <small class="text-danger">Điền đầy đủ các thông tin được mô tả
                                            dưới đây</small></h5>
                                    ...
                                    <div class="row mb15">
                                        ...
                                        <div class="col-lg-12 hidden">
                                            <div class="uk-flex uk-flex-middle uk-flex-space-between ">
                                                ...
                                                <a href="" title="" class="add-attr" onclick="return false;">Thêm Nội
                                                    dung +</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row attr-more hidden">
                            ...
                            <div class="ibox mb20 block-detail-product">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                                ...
                                                <div class="uk-flex uk-flex-middle">
                                                    <div class="m-r-sm">
                                                        <?php if (isset($price_contact) && $price_contact == 1) { ?>
                                                            <input type="checkbox" checked name="price_contact"
                                        ...
                                        <div class="col-lg-4 m-b hidden">
                                            <label class="control-label ">
                                                <span>Giá khuyến mại</span>
                                            </label>
                                            <div class="form-row">
                                                <?php echo form_input('price_input', set_value('price_input', number_format($product['price_input'], '0', ',', '.'), 0), 'class="form-control int" placeholder="đ" autocomplete="off"'); ?>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row block-inventory hidden"<?php echo ($inventory == 1) ? '' : ' style="display: none"' ?>>
                                        <div class="col-lg-6 mb15">
                                            <label class="control-label ">
                                            ...
                                            <div class="uk-flex uk-flex-middle">
                                                <div class="m-r-sm">
                                                    <?php if (isset($unlimited_sale) && $unlimited_sale == 1) { ?>
                                                        <input type="checkbox" checked name="unlimited_sale" value="1"
                                                               class="checkbox-item">
                                                        <div for="" class="label-checkboxitem checked"></div>
                                                    <?php } else { ?>
                                                        <input type="checkbox" name="unlimited_sale" value="1"
                                                               class="checkbox-item">
                                                        <div for="" class="label-checkboxitem "></div>
                                                    <?php } ?>
                                                </div>
                                                <div>
                                                    Cho phép bán âm (Không giới hạn số lượng sản phẩm trong đơn
                                                    hàng)
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="form-group" id="fromSlide">
                                    ...
                                    if (isset($slide) && is_array($slide) && count($slide)) {
                                        foreach ($slide['images'] as $key => $val) {
                                            $albumC[$key]['images'] = $val;
                                            $albumC[$key]['title'] = $slide['title'][$key];
                                            $albumC[$key]['description'] = $slide['description'][$key];
                                        }
                                    } else {
                                        $albumC = json_decode($product['albums'], TRUE);
                                    }
                                    ?>
                                    <?php if (isset($albumC) && is_array($albumC) && count($albumC)) { ?>
                                        <?php foreach ($albumC as $key => $val) {
                                            if (empty($albumC[$key]['images'])) continue; ?>
                                            <div class="col-sm-4 slideItem" style="height: auto;">
                                                <div class="thumb "><img
                                                            src="<?php echo !empty($albumC[$key]['images']) ? $albumC[$key]['images'] : 'template/not-found.png'; ?>"
                                                            class="img-thumbnail img-responsive"/></div>
                                                <input type="hidden" name="albumC[images][]"  value="<?php echo $albumC[$key]['images']; ?>"/>
                                                ...
                                                <textarea name="albumC[description][]" cols="40" rows="10"
                                                          class="form-control "
                                                          placeholder="Giá"><?php echo $albumC[$key]['description']; ?></textarea>
                            ...
                            <div class="ibox mb20 block-version "   data-countAttribute_catalogue="<?php echo $countAttribute_catalogue ?>">
                                <div class="ibox-title" style="padding-bottom: 15px;">
                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                        ...
                                        <div>
                                            <a class="show-version" <?php echo (!empty($version) && $version > 0) ? 'style="display:none"' : '' ?> >Thêm
                                                phiên bản</a>
                                    ...
                                    <small class="text-danger">Sản phẩm có các phiên bản dựa theo thuộc tính như kích
                                        thước hoặc màu sắc ? ( chọn tối đa 2 )</small>
                                </div>
                                <div class="ibox-content"
                                     style="background: #f5f6f7; display: <?php echo ($attribute_catalogue == 0) ? 'none' : 'block'; ?>">
							...
							<?php } */ ?>
                                    ...
                                    <div class="row block-attribute">
                                            ...
                                            <table class="table">
                                                ...
                                                <?php if (isset($attribute_catalogue) && is_array($attribute_catalogue) && count($attribute_catalogue)) { ?>
                                                        ...
                                                        <tr <?php echo (isset($checkbox[$key]) && $checkbox[$key] == 1) ? 'class="bg-active"' : '' ?>>
                                                            <td data-index="<?php echo $key ?>">
                                                                <?php if (isset($checkbox[$key]) && $checkbox[$key] == 1) { ?>
                                                                    <input type="checkbox" checked name="checkbox[]"
                                                                           value="1" class="checkbox-item">
                                                                    <input type="text" name="checkbox_val[]" value="1"
                                                                           class="hidden">
                                                                    <div for=""
                                                                         class="label-checkboxitem checked"></div>
                                                                <?php } else { ?>
                                                                    <input type="checkbox" name="checkbox[]" value="1"
                                                                           class="checkbox-item">
                                                                    <input type="text" name="checkbox_val[]" value="0"
                                                                           class="hidden">
                                                                    <div for="" class="label-checkboxitem "></div>
                                                                <?php } ?>
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php } else { ?>
                                                                    ...
                                                                    <select name="attribute[<?php echo $key ?>][]"
                                                                            data-json="<?php echo (isset($attribute_json[$key]['json'])) ? $attribute_json[$key]['json'] : '' ?>"
                                                                            data-condition="<?php echo 'AND catalogueid =' . $value ?>"
                                                                            class="form-control selectMultipe selectAttribute"
                                                                            multiple="multiple"
                                                                            data-title="Nhập 2 kí tự để tìm kiếm.."
                                                            ...
                                                            <td>
                                                                <a type="button"
                                                                   class="btn btn-default delete-attribute"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a type="button" class="btn btn-default delete-attribute"
                                                               data-id=""><i class="fa fa-trash"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php } ?>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                <a type="button"
                                                   data-attribute="<?php echo base64_encode(json_encode($dropdown)) ?>"
                                                   style="" class="btn btn-default add-attribute m-l-sm" data-id=""><i
                                                            class="fa fa-plus"></i> Thêm thuộc tính cho SP</a>
                                                <a data-toggle="modal" data-target="#create_attribute" class="hidden">
                                                    Tạo thuộc tính cho SP</a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php if ($version > 0) { ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <input type="text" name="attribute1[]"
                                                               value="<?php echo $attribute1[$key] ?>" class="hidden">
                                                        <div class="uk-flex uk-flex-middle hidden">
                                                            <div class="image mr5">
                                                                <div style="cursor: pointer;">
                                                                    <img src="<?php echo getthumb('template/not-found.png') ?>"
                                                                         class="js_choose_album" alt="">
                                                                </div>
                                                                <input type="text" name="image_version[]"
                                                                       value="<?php echo $image_version[$key] ?>"
                                                                       class="hidden">
                                                            </div>
                                                        </div>
                                                    </td>

                                                    <td><input type="text" name="title_version[]" readonly
                                                               value="<?php echo $title_version[$key] ?>"
                                                               class="form-control" autocomplete="off"></td>

                                                    <td><input type="text" name="price_version[]"
                                                               value="<?php echo addCommas($price_version[$key]) ?>"
                                                               class="form-control int" autocomplete="off"></td>

                                                    <td><input type="text" name="code_version[]"
                                                               value="<?php echo $code_version[$key] ?>"
                                                               class="form-control" autocomplete="off"></td>
                                                    <td class="hidden"><input type="text" name="barcode_version[]"
                                                               value="<?php echo $barcode_version[$key] ?>"
                                                               class="form-control" autocomplete="off"></td>
                                                </tr>
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <?php if (isset($quantity_start) && is_array($quantity_start) && count($quantity_start)) { ?>
                                                <table class="table">
                                                    ...
                                                    <?php foreach ($quantity_start as $key => $value) { ?>
                                                        <tr>
                                                            <td>
                                                                <input type="text" name="quantity_start[]"
                                                                       value="<?php echo $quantity_start[$key] ?>"
                                                                       class="int form-control"
                                                                       placeholder="Từ (sản phẩm)" autocomplete="off"
                                                                       style="width:120px">
                                                            </td>
                                                            <td>
                                                                <input type="text" name="quantity_end[]"
                                                                       value="<?php echo $quantity_end[$key] ?>"
                                                                       class="float form-control"
                                                                       placeholder="Đến (sản phẩm)" autocomplete="off"
                                                                       style="width:120px">
                                                            </td>
                                                            <td>
                                                                <input type="text" name="price_wholesale[]"
                                                                       value="<?php echo addCommas($price_wholesale[$key]) ?>"
                                                                       class="form-control float text-right"
                                            ...
                                            <?php } ?>
                                            <a type="button" style="" class="btn btn-default add-wholesale"
                                               data-id=""><i class="fa fa-plus"></i> Thêm khoảng giá</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div id="menu3" class="tab-pane fade">
                            <div class="ibox mb20">
                                <div class="ibox-title">
                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                        <h5>Tối ưu SEO <small class="text-danger">Thiết lập các thẻ mô tả giúp khách
                                                hàng dễ dàng tìm thấy bạn.</small></h5>
                                                ...
                                                <div class="form-row">
                                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                        ...
                                                        <span style="color:#9fafba;"><span
                                                                    id="titleCount"><?php echo strlen($product['meta_title']) ?></span> trên 70 ký tự</span>
                                                    </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="form-row">
                                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                        ...
                                                        <span style="color:#9fafba;"><span
                                                                    id="descriptionCount"><?php echo strlen($product['meta_description']) ?></span> trên 320 ký tự</span>
                                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="block clearfix">
                                            <div class="i-checks mr30" style="width:100%;"><span
                                                        style="color:#000;"> <input <?php echo ($this->input->post('publish') == 0) ? 'checked' : (($product['publish'] == 0) ? 'checked' : '') ?>  class="popup_gender_1 gender"
                                                                                                                                                                                                    type="radio"
                                                                                                                                                                                                    value="0"
                                        ...
                                        <div class="block clearfix">
                                            <div class="i-checks" style="width:100%;"><span style="color:#000;"> <input
                                                            type="radio" <?php echo ($this->input->post('publish') == 1) ? 'checked' : (($product['publish'] == 1) ? 'checked' : '') ?>  class="popup_gender_0 gender"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <div class="avatar" style="cursor: pointer;"><img
                                                    src="<?php echo ($this->input->post('banner')) ? $this->input->post('banner') : ((!empty($product['banner'])) ? $product['banner'] : 'template/not-found.png') ?>"
                                                    class="img-thumbnail" alt=""></div>
                                        <?php echo form_input('banner', htmlspecialchars_decode(html_entity_decode(set_value('banner', $product['banner']))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="ibox mb20 hidden">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <select name="tag[]" data-json="<?php echo base64_encode($product['tag']) ?>"
                                                data-condition="" class="form-control selectMultipe" multiple="multiple"
                                                data-title="Nhập 2 kí tự để tìm kiếm.." data-module="tag"
                                                style="width: 100%;">
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row uk-flex uk-flex-middle">
                                        <div class="icon_hot m-r" style="cursor: pointer;"><img
                                                    src="<?php echo ($this->input->post('icon_hot')) ? $this->input->post('icon_hot') : ((!empty($product['icon_hot'])) ? $product['icon_hot'] : 'template/not-found.png') ?>"
                                                    class="img-thumbnail" alt=""></div>
                    ...
                    <div class="ibox mb20 hidden">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <select name="prd_rela[]"
                                                data-json="<?php echo base64_encode($product['prd_rela']) ?>"
                                                data-condition="" class="form-control selectMultipe" multiple="multiple"
                                                data-title="Nhập 2 kí tự để tìm kiếm.." data-module="product"
                                                style="width: 100%;">
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="modal-content fadeInRight animated">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" value="" class="form-control tag-title" placeholder=""
                               autocomplete="off">
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <small class="font-bold text-danger">Cập nhật đầy đủ thông tin người dùng giúp việc quản lý dễ dàng
                        hơn</small>
                </div>
...
<script>
    ...
    item = item + '<div class="thumb"><img src="template/not-found.png" class="img-thumbnail img-responsive"/></div>';
    item = item + '<input type="hidden" name="albumC[images][]" value="template/not-found.png" />';
    item = item + '<input type="text" name="albumC[title][]" value="" class="form-control" placeholder="Tên"/>';
    item = item + '<textarea name="albumC[description][]" cols="40" rows="10" class="form-control" placeholder="Giá"></textarea>';
    item = item + '<button type="button" class="btn btnRemove btn-danger pull-right">Xóa bỏ</button>';
    item = item + '</div>';
    item = item + '<div class="col-sm-4 slideItem"><button type="button" class="btn btnAddItem pull-left">+</button></div>';
