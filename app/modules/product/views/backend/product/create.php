<div id="page-wrapper" class="gray-bg dashbard-1 fix-wrapper">
    ...
    <form method="post" action="" class="form-horizontal box">
        <div class="ibox-tools" id="create_product">
            <button type="submit" name="create" value="create" class="btn btn-success block full-width m-b">Tạo mới
            </button>
        </div>
            ...
            <div class="row">
                <div class="col-lg-8 clearfix">
                    <ul class="nav nav-pills ">
                        ...
                        <li><a data-toggle="tab" href="#menu3">Quà tặng</a></li>
                        <li><a data-toggle="tab" href="#menu1">Thuộc tính</a></li>
                    ...
                    <div class="tab-content">
                                ...
                                <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                    ...
                                    <div class="ibox-tools">
                                        <button type="submit" name="create" value="create"
                                                class="btn btn-success  full-width">Tạo mới
                                        </button>
                                    </div>
                        ...
                        <div id="home" class="tab-pane fade in active">
                                                        ...
                                                        <div class="col-lg-12 m-b desc-more">
                                                            <div class="row m-b">
                                                                <div class="col-lg-8">
                                                                    ...
                                                                    <input type="text" name="content[microtime][]"
                                                                           value="<?php echo $subs ?>" class="hidden">
                                                                </div>
                                                                <div class="col-lg-4">
                                                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                                        <a href="" title="" class="uploadMultiImage"
                                                                           onclick="openKCFinderDescExtend('<?php echo 'editor_' . $subs ?>');return false;">Upload
                                                                            hình ảnh</a>
                                                                        <button class="btn btn-danger delete-attr"
                                                                                type="button"><i
                            ...
                            <div class="ibox mb20 album">
                                <div class="ibox-title">
                                    <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                        <h5>Album Ảnh CHI TIẾT SẢN PHẨM</h5>
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 m-b hidden">
                                            <label class="control-label ">
                                                <span>Giá nhập hàng</span>
                                            </label>
                                            <div class="form-row">
                                                <?php echo form_input('price_input', set_value('price_input', 0), 'class="form-control int" placeholder="đ" autocomplete="off"'); ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row block-inventory hidden"<?php echo (!empty($inventory) && $inventory == 1) ? '' : ' style="display: none"' ?>>
                                        <div class="col-lg-6 mb15">
                                            <label class="control-label ">
                        ...
                        <div id="menu1" class="tab-pane fade">
                            <div class="ibox mb20 block-version "
                                 data-countattribute_catalogue="<?php echo $countAttribute_catalogue ?>">
                                ...
                                <div class="ibox-content"
                                     style="background: #f5f6f7; <?php echo (!empty($attribute)) ? '' : 'display:none"' ?>">
                                                        ...
                                                        <div class="col-lg-3 ">
                                                            <div class="image_color m-b-xs" style="cursor: pointer;">
                                                                <div class="image_small"
                                                                     style=" background: <?php echo $val['color'] ?>">
                                                                    <img src="<?php echo $image_color[$key] ?>" alt="">
                                                                </div>
                                                                <input type="text"
                                                                       name="image_color[<?php echo $key ?>]" value=""
                                                                       class="hidden" onclick="openKCFinder(this)">
                                                            </div>
                                    ...
                                    <div class="row block-attribute">
                                                            ...
                                                            <td>
                                                                ...
                                                                <?php } else { ?>
                                                                    ...
                                                                    <select name="attribute[<?php echo $key ?>][]"
                                                                            data-json="<?php echo $attribute_json[$key]['json'] ?>"
                                                                            data-condition="<?php echo 'AND catalogueid =' . $value ?>"
                                                                            class="form-control selectMultipe"
                                                                            multiple="multiple"
                                        ...
                                        <div class="col-lg-12">
                                            <div class="uk-flex uk-flex-middle uk-flex-space-between">
                                                ...
                                                <a data-toggle="modal" class="hidden" data-target="#create_attribute">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <input type="text" name="attribute2[]"
                                                               value="<?php echo $attribute2[$key] ?>" class="hidden">
                                                        <div class="uk-flex uk-flex-middle">
                                                            <div class="image mr5">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" name="price_wholesale[]"
                                                                       value="<?php echo $price_wholesale[$key] ?>"
                            ...
                            <div class="ibox mb20">
                                ...
                                <div class="ibox-content">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="google">
                                                <div class="g-title"><?php echo ($this->input->post('meta_title')) ? $this->input->post('meta_title') : (($this->input->post('title')) ? $this->input->post('title') : 'OVN CRM - Đơn vị thiết kế website hàng đầu Việt Nam'); ?></div>
                                                <div class="g-link"><?php echo ($this->input->post('canonical')) ? site_url($this->input->post('canonical')) : 'https://ovn-admin.vn/kho-giao-dien-website.html'; ?></div>
                            ...
                            <div class=" mb20">
                                <div class="form-group" id="fromSlide">
                                    ...
                                    if (isset($albumC) && is_array($albumC) && count($albumC)) { ?>
                                        <?php foreach ($albumC['images'] as $key => $val) {
                                            if (empty($albumC['images'][$key])) continue; ?>
                                            <div class="col-sm-4 slideItem" style="height: auto;">
                                                <div class="thumb"><img src="<?php echo $albumC['images'][$key]; ?>"
                                                                        class="img-thumbnail img-responsive"/></div>
                                                <input type="hidden" name="albumC[images][]"
                                                       value="<?php echo $albumC['images'][$key]; ?>"/>

                                                <input type="text" name="albumC[title][]"
                                                       value="<?php echo $albumC['title'][$key]; ?>"
                                                       class="form-control title " placeholder="Tên ảnh"/>
                                                <textarea name="albumC[description][]" cols="40" rows="10"
                                                          class="form-control "
                                                          placeholder="Giá"><?php echo $albumC['description'][$key]; ?></textarea>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="post-setting">
                                        <a href="" title="" class="setting-button mb5" data-flag="0">Thiết lập ngày/giờ
                                            hiển thị</a>
                    ...
                    <div class="ibox mb20 hidden">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <div class="avatar" style="cursor: pointer;"><img src="template/not-found.png"
                                                                                          class="img-thumbnail" alt="">
                                        </div>
                                        <?php echo form_hidden('banner', htmlspecialchars_decode(html_entity_decode(set_value('banner'))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"'); ?>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-row uk-flex uk-flex-middle">
                                        <div class="icon_hot m-r" style="cursor: pointer;"><img
                                                    src="<?php echo ($this->input->post('icon_hot')) ? $this->input->post('icon_hot') : 'template/not-found.png' ?>"
...
<script>
    ...
    item = item + '<input type="hidden" name="albumC[images][]" value="" />';
