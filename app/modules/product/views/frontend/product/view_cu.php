                    ...
                    <div>
                            ...
                            <form method="post" action="" class="form-addtocart"><!---->
                                <div options="" class="product-detail-first-block">
                                    <div class="block-detail-top">
                                                ...
                                                <div class="product-images">
                                                    <div class="product-image-single"><!---->
                                                        <div class="item image"><img
                                                                ...
                                                                style="height: 396.6px;object-fit: contain"></div>
                                                    </div>
                                        ...
                                        <div class="product-detail"><h1
                                                class="title"><?php echo $productDetail['title']; ?></h1> <!---->
                                            <!---->
                                            <div class="intro">
                                                <div class="star">
                                                    <a href="<?php echo $canonical ?>#reviews" class="empty-review"><img
                                                            src="template/frontend/images/pencil.svg"
                                                            alt="Viết nhận xét"> Viết nhận xét
                                                    </a>
                                                </div>
                                                    ...
                                                    <?php if ($productDetail['highlight'] == 0) { ?>
                                                        ...
                                                        <div class="actions" style="margin-top: 0px">
                                                            <div class="button-action hidden">
                                                                ...
                                                                <button type="button" title="MUA NGAY"
                                                                        class="set-paymentmethod">Thanh toán VNPAY
                                                                    <span>ATM nội địa | QRcode</span>
                                                                </button>
                                                            </div>
                                                            ...
                                                            <div class="block-find-store"><p class="find-store"></p>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div>
                                                            <div class="status-outofstock">
                                                                ...
                                                                <div class="number-phone">
                                                                    ...
                                                                    <p>Gọi/chat với chúng tôi để nhận tư vấn thêm</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="col-block-right">
                                        ...
                                        <?php if (isset($slide_loiich) && is_array($slide_loiich) && count($slide_loiich)) { ?>
                                            ...
                                            <div class="detail-block-right-top"><h3>Lợi ích khi mua hàng
                                                    tại <?php echo $this->fcSystem['homepage_brandname'] ?></h3>
                                                <?php foreach ($slide_loiich as $key => $val) { ?>
                                                    <p><span class="icon"><img src="<?php echo $val['src'] ?>"
                                                                               alt="<?php echo $val['title'] ?>"></span><span
                                                            class="text"> <?php echo $val['title'] ?></span></p>
                                                <?php } ?>
                                            </div>
                                        <?php } ?>
                                        ...
                                        $groupValue = [];
                                        if (isset($listAddress)) {
                                            $groupValue = groupValue($listAddress, 'address_city');
                                        }


                                        ?>
                                        <div id="store-detail">
                                            <h3>Cửa hàng có sẵn hàng</h3>
                                            <select class="showroom_city_id">

                                                <option value="0"> -- Thành phố / Tỉnh --</option>

                                                <?php if (isset($groupValue)) { ?>
                                                    <?php $i = 0;
                                                    ...
                                                    <?php foreach ($listAddress as $k => $v) { ?>
                                                        <li>
                                                            <a href="https://www.google.com/maps/dir/__origLatitude__,__origLongitude__/<?php echo $v['lat'] ?>,<?php echo $v['long'] ?>/@<?php echo $v['lat'] ?>,<?php echo $v['long'] ?>"
                                                               ...
                                                               target="_blank"><?php echo $v['fullname'] ?>
                                                                - <?php echo $v['address'] ?></a>
                                                        </li>
                                                    <?php } ?>
                                                    ...
                                                    <?php if (isset($v)) { ?>
                                                        <ul class="city_<?php echo $i ?> city-wrapper" style="display: none">
                                                            <?php foreach ($v as $kC => $vC) { ?>
                                                                <li>
                                                                    <a href="https://www.google.com/maps/dir/__origLatitude__,__origLongitude__/<?php echo $vC['lat'] ?>,<?php echo $vC['long'] ?>/@<?php echo $vC['lat'] ?>,<?php echo $vC['long'] ?>"

                                                                       target="_blank"><?php echo $vC['fullname'] ?>
                                                                        - <?php echo $vC['address'] ?></a>
                                                                </li>
                                                            <?php } ?>
                                                        </ul>
                                                    <?php } ?>
                                            ...
                                            <?php } ?>
                                            <script>
                                                $('.showroom_city_id').change(function () {
                        ...
                        <div id="product-detail-product-info-detail" class="product-detail-product-info-detail">
                            ...
                            <div class="product-info-detailed">
                                                        ...
                                                        <div class="additional-attributes">
                                                            ...
                                                            <?php foreach ($attrFinal as $k => $v) { ?>
                                                                <div class="attribute-item">
                                                                    <div class="col label"><span><?php echo $k ?></span>
                                                                    </div>
                                                                    <div class="col data">
                                                                        <?php $i = 0;
                                                                        foreach ($v as $kp => $vp) {
                                                        ...
                                                        <?php foreach ($relaList as $keyPost => $valPost) {
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="product-items">
                                                                    <div class="product-item" style="border-bottom: 0px">
                                                                        <div class="product-item-info">
                                                                            <div class="cdz-product-top">
                                                                                <a href="<?php echo $href ?>" tabindex="0">
                                ...
                                <?php
                                $sanphamhot = $this->Autoload_Model->_get_where(array(
                                    'select' => 'id, title,canonical,description,price,price_sale,price_contact,image',
                                    'table' => 'product',
                                    'limit' => 5,
                                    'where' => array('ishome' => 1, 'publish' => 0, 'alanguage' => $this->fc_lang)), true);
                                ?>
                                <?php if (is_array($sanphamhot) && isset($sanphamhot) && count($sanphamhot)) { ?>
                                                            ...
                                                            <div class="product-item">
                                                                <div class="product-item-info">
                                                                    ...
                                                                    <div class="product details product-item-details active-freeship">
                                                                        <h3 class="product-item-link"><a
                                                                                href="<?php echo $href ?>"
                                                                                class="product-item-link"><?php echo $v['title'] ?></a>
                                                                        </h3>
                                                                        <div class="price-freeship">
                                                                            <div class="price-product price-box price-final_price">
                                                                                <div class="new-price"><span
                                                                                        class="price"><?php echo $getPrice['price_final'] ?></span>
                                                                                </div>
                                                                            </div>
                                                                            <div class="freeship-product">Freeship</div>
                                                                        </div>
                                                                        <div class="view-detail"><a
                                                                                href="<?php echo $href ?>">Mua
                                                                                Ngay</a></div>
                                                                    </div>
                                                                </div>
                                                            </div>
