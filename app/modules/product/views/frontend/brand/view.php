    ...
    <div class="breadcrumbs">
        <ul class="items">
            <li class="item home">
                ...
                <li><?php echo $detailCatalogue['title']; ?>
                </li>
        </ul>
    </div>
</div>
                            ...
                            <script>
                                $(function () {
                                    $('#sorter').on('change', function () {
                                        ...
                                        if (url) {
                                            if (url == '') {
                                                window.location = '<?php echo $canonical?>';

                                            } else {
                                                window.location = '<?php echo $canonical?>?sort=' + url;
...
<style>
    ...
    #shomesolution-product-filter .block.product-list{
        width: 100%;
        -webkit-box-flex: 0;
        -ms-flex: 0 0  100%;
        flex: 0 0  100%;
    ...
    .category-nem #shomesolution-product-filter .block.product-list .arrange-fill, [class*=category-nem-] #shomesolution-product-filter .block.product-list .arrange-fill {
        -webkit-box-flex: 0;
        -ms-flex: 0 0 50%;
        flex: 0 0 50%;
        max-width: 50%;
