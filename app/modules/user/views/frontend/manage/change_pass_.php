					...
					<div class="col-sm-12">
						<fieldset id="personal-details">
							...
							<div class="form-group required">
								...
								<?php echo form_password('newpassword', set_value('newpassword'), 'placeholder="Mật khẩu mới" class="field__input form-control" placeholder="" autocomplete="off"');?>
							</div>

							<div class="form-group required">
								<label for="input-telephone" class="control-label">Nhập lại mật khẩu mới</label>
								<?php echo form_password('renewpassword', set_value('renewpassword'), 'placeholder="Xác nhận mật khẩu mới" class="field__input form-control" placeholder="" autocomplete="off"');?>
							</div>
