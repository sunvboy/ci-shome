                                ...
                                <div class="col-lg-6">
                                    <div class="form-row"><label class="control-label text-left">
                                        ...
                                        <div class="uk-flex uk-flex-middle">
                                            ...
                                            </div> <?php echo form_input('avatar', htmlspecialchars_decode(html_entity_decode(set_value('avatar'))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
