                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="uk-flex uk-flex-middle">
                                            <div class="i-checks mr30"><label>
                                                    <input <?php echo ($gender == 1) ? 'checked' : '' ?>
                                                            class="popup_gender_1 gender" type="radio" value="1"
                                                            name="gender"> <i></i> Nam</label></div>
                                            <div class="i-checks"><label> <input
                                                            type="radio" <?php echo ($gender == 0) ? 'checked' : '' ?>
                                                            class="popup_gender_0 gender" required value="0"
                                                            name="gender"> <i></i> Nữ </label></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-row"><label class="control-label text-left">
                                        ...
                                        <div class="uk-flex uk-flex-middle">
                                            <div class="avatar" style="cursor: pointer;"><img
                                                        ...
                                                        src="<?php echo ($this->input->post('avatar')) ? $this->input->post('avatar') : ((!empty($detailUser['avatar'])) ? $detailUser['avatar'] : 'template/not-found.png') ?>"
                                                        class="img-thumbnail" alt="">
                                            </div> <?php echo form_input('avatar', htmlspecialchars_decode(html_entity_decode(set_value('avatar',$detailUser['avatar']))), 'class="form-control " placeholder="Đường dẫn của ảnh" onclick="openKCFinder(this)"  autocomplete="off"'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="toolbox action clearfix">
                                <div class="uk-flex uk-flex-middle uk-button pull-right">
                                    <button class="btn btn-primary btn-sm" name="update" value="update" type="submit">
                                        Cập nhật
                                    </button>
                                </div>
                            </div>
