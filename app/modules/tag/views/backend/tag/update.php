							...
							<div class="row mb15">
								...
								<div class="form-row col-lg-12">
									<label class="control-label text-left panel-head-1">
										<span>Chọn danh mục <b class="text-danger">(*)</b></span>
									</label>
									<?php echo form_dropdown('catalogueid', dropdown(array(
										...
										'value'=>'title',
										'order_by'=>'id DESC'
									)), set_value('catalogueid', $detailTag['catalogueid']) ,'class="form-control input-sm perpage filter catalogueid" style="height:34px !important"'); ?>
