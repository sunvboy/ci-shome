							...
							<table class="table table-bordered table-hover " >
								<thead>
									<tr>
										...
										<th style="width:70px;" class="text-center hidden">Nổi bật</th>
									...
									<?php if(isset($listpromotional) && is_array($listpromotional) && count($listpromotional)){ ?>
										<?php foreach($listpromotional as $key => $val){ ?>
											...
											<tr class="gradeX " id="post-<?php echo $val['id']; ?>">
												...
												<td class="text-center hightlight hidden" data-id="<?php echo $val['id'] ?>">
													<?php 
														if($val['hightlight'] == 1){
												...
												<td class="">
													<div class="switch">
														<div class="onoffswitch">
															<input type="checkbox" <?php echo ($val['publish'] == 0) ? '' : 'checked=""'; ?> class="onoffswitch-checkbox publish_frontend" data-module="promotional" data-title="publish" data-id="<?php echo $val['id']; ?>" id="publish-<?php echo $val['id']; ?>">
