		...
		<div class="wrapper wrapper-content animated fadeInRight">
			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					?>	
					<?php if($this->auth['account'] == 'SUNVBOY'){ ?>
			...
			<div class="row">
				<div class="col-lg-6">
					<div class="image-preview">
						<span class="image img-cover"><img src="<?php echo ($detailLayout['catalogueid'] == 5) ? $this->fcSystem['preview_image'] : $this->fcSystem['preview_image_sidebar']; ?>" alt="" /></span>
					</div>
				</div>
