        ...
        <div class="wrapper wrapper-content animated fadeInRight">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-row">
                                        <label class="control-label text-left">
                                            <span><?php echo ($this->input->get('parentid') > 0) ? 'Menu Cha' : 'Vị trí' ?> <b
                            ...
                            <div class="menu-list">
                                ...
                                <?php if (isset($menu['title']) && is_array($menu['title']) && count($menu['title'])) { ?>
                                            ...
                                            <div class="col-lg-2">
                                                <div class="form-row">
                                                    <div class="avatar local_result" style="cursor: pointer;"><img
                                                                ...
                                                                src="<?php echo !empty($menu['image'][$key]) ? $menu['image'][$key] : 'template/not-found.png' ?>"
                                                                class="img-thumbnail"
                                                                alt=""></div>
                                                    <input type="hidden" name="menu[image][]"
                                                           value="<?php echo $menu['image'][$key]; ?>"></div>
                                            </div>
                                    ...
                                    $listMenu = $this->Autoload_Model->_get_where(array(
                                        'select' => 'id, title, link, order,image,ishome',
                                        'table' => 'navigation',
                                            ...
                                            <div class="row mb15 menu-wrapper">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-row">
                                                        <div class="avatar local_result" style="cursor: pointer;"><img
                                                                    style="height: 32px;text-align: center;max-width: 100%"
                                                                    src="<?php echo !empty($val['image']) ? $val['image'] : 'template/not-found.png' ?>"
                                                                    class="img-thumbnail"
                                                                    alt=""></div>
                                                        <input type="hidden" name="menu[image][]"
                                                               value="<?php echo $val['image']; ?>"></div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <input type="text" placeholder=""
            ...
            <div class="toolbox action clearfix">
                <div class="uk-flex uk-flex-middle uk-button pull-right">
                    <button class="btn btn-primary btn-sm" name="create" value="create" type="submit">Lưu thay đổi
                    </button>
                </div>
            </div>
        </div>
