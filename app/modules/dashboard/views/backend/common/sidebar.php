    ...
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header text-center">
                ...
                <div class="logo-element"> OVN CRM+</div>
            </li>
            ...
            <?php if (in_array('bill/backend/bill/view', json_decode($this->auth['permission'], TRUE)) && in_array('bill', $dropdown)) { ?>

                <li class="<?php echo ($this->router->module == 'bill') ? 'active' : '' ?>">
                    <a href="<?php echo site_url('bill/backend/bill/view'); ?>"><i class="fa fa-truck"></i> <span
                                class="nav-label"> Quản lý hóa đơn</span></a>
                </li>
            <?php } ?>

            <?php if (in_array('customer/backend/customer/view', json_decode($this->auth['permission'], TRUE)) && in_array('customer', $dropdown)) { ?>
                <li class="<?php echo ($this->router->module == 'customer') ? 'active' : '' ?>">
                    <a href="<?php echo site_url('customer/backend/customer/view'); ?>"><i class="fa fa-users"></i><span
                                class="nav-label"> Quản lý khách hàng</span><span class="fa arrow"></span></span></a>

                    <ul class="nav nav-second-level">
                        <li><a href="<?php echo site_url('customer/backend/catalogue/view'); ?>">Quản lý nhóm khách
                                hàng</a></li>
                        <li><a href="<?php echo site_url('customer/backend/customer/view'); ?>">Quản lý khách hàng</a>
                        </li>
                        <?php if (in_array('customer/backend/customer/config', json_decode($this->auth['permission'], TRUE))) { ?>
                            <li class=""><a href="<?php echo site_url('customer/backend/customer/config'); ?>">Cấu hình</a></li>
                        <?php } ?>
            ...
            <?php if (in_array('order/backend/order/view', json_decode($this->auth['permission'], TRUE)) && in_array('order', $dropdown)) { ?>
                ...
                <li class="<?php echo ( $this->router->module == 'order') ? 'active' : '' ?>">
                    <a href="<?php echo site_url('supplier/backend/supplier/view'); ?>"><i class="fa fa-cart-plus" aria-hidden="true"></i><span
            ...
            <?php if (in_array('media/backend/media/view', json_decode($this->auth['permission'], TRUE)) && in_array('media', $dropdown)) { ?>
                ...
                <li class="<?php echo ($this->router->module == 'media') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-camera-retro"></i> <span class="nav-label"> Quản lý thư viện</span><span
                                class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class="hidden"><a href="<?php echo site_url('media/backend/catalogue/view'); ?>">Nhóm thư viện</a></li>
            ...
            <?php if (in_array('tag/backend/tag/view', json_decode($this->auth['permission'], TRUE)) && in_array('tag', $dropdown)) { ?>
                <li class="<?php echo ($this->router->module == 'tag') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-tag"></i> <span class="nav-label">Quản lý tag</span><span  class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="<?php echo site_url('tag/backend/catalogue/view'); ?>">Quản lý danh mục tag</a></li>
            ...
            <?php if (in_array('support/backend/support/view', json_decode($this->auth['permission'], TRUE)) && in_array('support', $dropdown)) { ?>
                ...
                <li class="<?php echo ($this->router->module == 'support') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-users"></i><span class="nav-label">Danh sách cửa hàng</span><span
                                class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class=""><a href="<?php echo site_url('support/backend/catalogue/view'); ?>">Tỉnh thành/Quận huyên</a></li>
            ...
            <?php if (in_array('contact/backend/contact/view', json_decode($this->auth['permission'], TRUE)) && in_array('contact', $dropdown)) { ?>
                ...
                <li class="<?php echo ($this->router->module == 'contact') ? 'active' : '' ?>">
                    <a href="#"><i class="fa fa-envelope"></i><span class="nav-label">Liên Hệ</span><span
                                class="fa arrow"></span></a>
                    <ul class="nav nav-second-level collapse">
                        <li class=""><a href="<?php echo site_url('contact/backend/catalogue/view'); ?>">Nhóm liên hệ</a></li>
                        <li class=""><a href="<?php echo site_url('contact/backend/contact/view'); ?>">Danh sách liên hệ</a></li>
            ...
            <li class="<?php echo ($this->router->module == 'general' ) ? 'active' : '' ?> <?php echo ($this->router->module == 'navigation') ? 'active' : '' ?> <?php echo ($this->router->module == 'layout') ? 'active' : '' ?>">
                <a href="#"><i class="fa fa-cog"></i> <span class="nav-label">Cấu hình chung</span><span
                            class="fa arrow"></span></a>
                <ul class="nav nav-second-level collapse">
                    <li><a href="<?php echo site_url('layout/backend/layout/refreshSidemap'); ?>">Cập nhật SiteMap</a>
                    </li>
