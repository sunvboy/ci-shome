...
<head>
    ...
    <meta property="og:image" content="<?php echo (isset($meta_image) && !empty($meta_image)) ? $meta_image : $this->fcSystem['homepage_logo'] ?>" />
    ...
    <meta name="twitter:image" content="<?php echo (isset($meta_image) && !empty($meta_image))?$meta_image:$this->fcSystem['homepage_logo']?>" />
    <link rel="icon" href="<?php echo $this->fcSystem['homepage_favicon']; ?>"  type="image/png" sizes="30x30">

    <script type="text/javascript">
    var BASE_URL = '<?php echo base_url(); ?>';
    </script>
	<?php $this->load->view('homepage/mobile/common/head'); ?>
...
<div class="page-body-buong">
    ...
    <?php $this->load->view('homepage/mobile/core/cart'); ?>
</div>
