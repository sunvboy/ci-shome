...
<div class="fab-wrapper">
   ...
   <div class="fab-wheel">
      <a class="fab-action fab-action-1" href="https://shomesolution.vn/stores.html" rel="nofollow" target="_blank">
         <div class="fab-button fab-button-1"><i class="icon-cps-local"></i></div> 
         <span class="fab-title">Tìm cửa hàng</span>
      </a>
      <a class="fab-action fab-action-2" href="tel:0946882992" rel="nofollow">
         <div class="fab-button fab-button-2"><i class="icon-cps-phone"></i></div> 
         <span class="fab-title">Gọi trực tiếp</span>
      </a>
      <a class="fab-action fab-action-3" onclick="subiz('expandWidget')" rel="nofollow">
         <div class="fab-button fab-button-3"><i class="icon-cps-chat"></i></div> 
         <span class="fab-title">Chat ngay</span>
      </a>
      <a class="fab-action fab-action-4" href="https://zalo.me/0946882992" target="_blank" rel="nofollow">
   ...
   <div class="suggestions-chat-box hidden" style="display: none;">
      <div class="box-content d-flex justify-content-around align-items-center">
         ...
         <p class="mb-0 font-14"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Liên hệ ngay</p>
      </div>
   </div>
