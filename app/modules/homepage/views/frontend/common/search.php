                    ...
                    <?php if(!empty($mausac)){?>
                        <div class="item2" style="width: 100%">
                            ...
                            <div class="nav-checkbox">
                                ...
                                <?php }?>
                                <div class="hideColor" style="display: none">
                                    <?php foreach ($mausac as $key=>$val){?>
                                        <?php if($key > 7){?>
                                            <div class="checkbox">
                                                <input onclick="clickMauSac('<?php echo $val['id']?>')" class="js_mausac" type="checkbox" value="<?php echo $val['id']?>" id="a<?php echo $val['id']?>">
                                        ...
                                        <?php }?>
                                    <?php }?>
                                    <a href="javascript:void(0)" class="add truColor" style="display: none">-</a>

                                </div>

                                <?php if(count($mausac) >8){?>
                                <a href="javascript:void(0)" class="add addColor">+</a>
                                <?php }?>
                            </div>
                        </div>
                ...
                <div class="item">
                    <?php if(!empty($dactinhsanpham)){?>
                        <div class="item1 item3" style="margin-top: 0px">
                            <h3 class="title-top"><span class="title">Hạn sử dụng</span>
