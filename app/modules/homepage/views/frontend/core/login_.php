            ...
            <div class="modal-body">
                <form role="form" id="dangky_form" method="post" class="validate ">
                    ...
                    <div class="creat-admin">
                        <input type="submit" value="Tạo tài khoản"> <span>  Bạn đã có tài khoản? <a id="dangnhap_click"
                                                                                                    href="javascript:void(0)">Đăng nhập</a> ngay</span>
                    </div>
                </form>
            </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="login_form" method="post">
                    ...
                    <div class="creat-admin">
                        <input type="submit" value="Đăng nhập" id="btn-submit"> <a id="forgot_click"
                                                                                   href="javascript:void(0)"
                                                                                   style="text-decoration: underline;">Quên
                            mật khẩu</a>
                    </div>
                    <div class="creat-admin" style="margin-top: 10px">
                        <span>  Bạn chưa có tài khoản? <a id="dangky_click"
                                                          href="javascript:void(0)">Đăng ký</a> ngay</span>
