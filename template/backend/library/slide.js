	...
	html = html + '<div class="row">';
		html = html + '<div class="col-lg-6">';
			html = html + '<div class="form-row">';
				...
				html = html + '<div class="avatar slide-image image-scaledown" style="cursor: pointer;height: 100px"><img src="'+object.src+'" class="img-thumbnail" alt="" style="height: 100px;width: 100%"></div>';
